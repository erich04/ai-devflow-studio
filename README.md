...
![Current Electron workbench with stage navigation, node details and a separate conversation pane](docs/guides/screenshots/readme-20260924/desktop-workbench.png)

_Current Electron UI, captured from source on September 24, 2026 with isolated demo data. Stage selection, actual workflow progress, node details, and conversations have separate controls. [Capture details](docs/guides/screenshots/readme-20260924/README.md)._
...
![Current Electron Gate reader showing material, policy and an explicit decision](docs/guides/screenshots/readme-20260924/desktop-gate-review.png)

_The Gate reader brings the material and decision into the same workspace. The material and review were generated by the deterministic demo provider in a disposable local project._
...
![Current Web console showing a selected project's workflow, evidence chain and human Gate](docs/guides/screenshots/readme-20260924/web-workbench.png)

_Current Next.js Web UI backed by the local API's explicit demo dataset. Full-size captures and their source commit are recorded with the [screenshots](docs/guides/screenshots/readme-20260924/README.md)._
