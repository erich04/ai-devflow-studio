...
| `corepack pnpm test:docker-lifecycle-smoke` | Fresh Team schema v13, retained V1.4 schema v10 upgrade, transactional populated v11-to-v12 retry, fail-closed v12-to-v13 provider-authoritative expiry migration, and bounded V1.4 backup/restore rollback. |
