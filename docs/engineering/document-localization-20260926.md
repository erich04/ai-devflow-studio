...
本轮 171/171 份已逐文件完成中文化或完整校对；页面渲染与最终 CI 结果另见[验证记录](../validation/open-issues-workbench-20260926.md)。
...
| [docs/plans/v0.3-team-backend-synchronization.md](../../docs/plans/v0.3-team-backend-synchronization.md) | 已翻译并校对 | 完整译文；逐字保留 12 组验证命令和文件路径，说明 v0.3 演示认证为历史边界 |
...
| [docs/plans/v1.3-closeout-execution-2026-07-31.md](../../docs/plans/v1.3-closeout-execution-2026-07-31.md) | 已翻译并校对 | 完整译文；保留 25 项不变量、8 个切片、历史未完成状态及候选/证据提交边界 |
| [docs/plans/v1.3-delivery-flow-completion.md](../../docs/plans/v1.3-delivery-flow-completion.md) | 已翻译并校对 | 完整译文；保留写入/证据权限、历史失败结果、未授权演练及候选签收流程 |
| [docs/plans/v1.4-pilot-trust-boundary.md](../../docs/plans/v1.4-pilot-trust-boundary.md) | 已翻译并校对 | 正文与历史进度已翻译；保留预算矩阵、认证和发件箱边界、验证数字及历史/发布状态区分 |
| [docs/plans/v1.4-release-signoff.md](../../docs/plans/v1.4-release-signoff.md) | 已翻译并校对 | 全文说明已翻译；原始命令、代码/测试样例和发布 JSON 块保留原文并说明原因，保留历史状态与授权约束 |
...
| [docs/plans/v3.x-agent-runtime-capability-roadmap.md](../../docs/plans/v3.x-agent-runtime-capability-roadmap.md) | 已翻译并校对 | 完整译文；保留未正式纳入路线图的草案状态、V3.0 依赖及各版本非目标 |
...
| [docs/product/prd/v1.4-pilot-trust-boundary-prd.md](../../docs/product/prd/v1.4-pilot-trust-boundary-prd.md) | 已翻译并校对 | 正文与操作说明已翻译；保留版本、命令、权限边界及兼容锚点 |
...
| [docs/roadmap.md](../../docs/roadmap.md) | 已翻译并校对 | 全文与版本职责已校对；核对 GitHub 标签及发布证据后纠正 V2.3 当前发布状态，历史候选/权限/证据保持，兼容旧锚点 |
| [docs/superpowers/plans/2026-06-17-near-term-opencode-signoff.md](../../docs/superpowers/plans/2026-06-17-near-term-opencode-signoff.md) | 已翻译并校对 | 正文和任务已翻译；保留历史命令/原始输出并注明非本轮验证，保留原复选框状态 |
| [docs/superpowers/plans/2026-06-17-v0.6.1-real-opencode-runtime.md](../../docs/superpowers/plans/2026-06-17-v0.6.1-real-opencode-runtime.md) | 已翻译并校对 | 全文说明已翻译；原始命令、代码/测试样例和发布 JSON 块保留原文并说明原因，保留历史状态与授权约束 |
...
| [知识点总结.md](../../知识点总结.md) | 原为中文，已完整校对 | 保留题目、题号、英文算法/产品名与原始引用；补充归档用途和中文标题，兼容旧锚点，不将第三方观点当作产品能力 |
