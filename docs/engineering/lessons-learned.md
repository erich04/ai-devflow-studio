...
- **Checks**:
  ...
  - Prove a clean database reaches Team schema v16, a populated v11-to-v12 upgrade retains exact
    ...
    Runtime summaries/audit without inventing rows for retained data.
