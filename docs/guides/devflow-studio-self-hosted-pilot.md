...
Until V1.4 candidate formation, repository package metadata remains `1.3.0`; therefore development
artifacts also retain that version label. A version label alone is never evidence of V1.4 signoff.
