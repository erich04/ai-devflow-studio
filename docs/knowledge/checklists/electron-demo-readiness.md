...
summary: Electron demos should prove Desktop schema v18, production boundaries, durable Agent Runtime recovery, governed GitHub Delivery, and credential containment.
---
...
- Confirm the local SQLite database reports Desktop schema v18 and refuses an unknown newer schema.
- Run the packaged pilot Runtime probe and confirm its accepted action count remains exactly one after cold restart.
