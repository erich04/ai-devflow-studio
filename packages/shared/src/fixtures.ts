...
summary: Electron demos should prove Desktop schema v24, production boundaries, durable Agent Runtime and Local MCP audit recovery, governed GitHub Delivery, and credential containment.
---
...
- Confirm the local SQLite database reports Desktop schema v24, retains the v20 outbox across the
