...
summary: Electron demos should prove Desktop schema v19, production boundaries, durable Agent Runtime and Native Tool audit recovery, governed GitHub Delivery, and credential containment.
---
...
- Confirm the local SQLite database reports Desktop schema v19 and refuses an unknown newer schema.
- Run the packaged pilot Runtime probe and confirm its accepted action count remains exactly one after cold restart and that it retains one started and one succeeded Native Tool audit.
