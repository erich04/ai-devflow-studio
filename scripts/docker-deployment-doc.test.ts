...
describe('self-hosted Docker deployment files', () => {
  ...
  it('documents the self-hosted pilot walkthrough', () => {
    ...
    expect(guide).toContain('一次性迁移')
    expect(guide).toContain('/ready')
    expect(guide).toContain('允许的 API 环境变量')
