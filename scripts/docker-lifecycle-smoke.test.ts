...
describe('V1.5 Docker lifecycle smoke contract', () => {
  ...
  it('proves fresh schema v13 and a volume-retained V1.4 schema v10 upgrade', () => {
    ...
    expect(lifecycleSmoke).toContain("expectSchemaVersion(FRESH_DATABASE, 13)")
    ...
    expect(lifecycleSmoke).toContain("expectSchemaVersion(UPGRADE_DATABASE, 13)")
  ...
  it('migrates a legacy issued v12 credential to v13 without inventing provider expiry proof', () => {
    ...
    expect(lifecycleSmoke).toContain("expectSchemaVersion(FAILURE_DATABASE, 13)")
  ...
  it('documents the bounded API and Desktop rollback windows', () => {
    ...
    expect(guide).toContain('Team schema v13')
