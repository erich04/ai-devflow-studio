...
try {
  ...
  await first.page.getByRole('button', { name: '同步团队并刷新 snapshot', exact: true }).click()
  await expect(first.page.getByTestId('team-sync-feedback')).toContainText('同步成功 · 策略 v1', { timeout: 20_000 })
