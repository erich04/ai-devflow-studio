...
describe('V2.1 Evaluated Retrieval and Memory contract', () => {
  ...
  it('keeps the single active Roadmap priority on V2.1 Slice 5 while Context integration progresses', () => {
    ...
    expect(plan).toMatch(/197 test files and 2788 tests/u)
    ...
    expect(roadmap).toContain('| Next gate | Prove zero-repeat packaged restart for exact Memory human actions |')
