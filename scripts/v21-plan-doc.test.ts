...
describe('V2.1 Evaluated Retrieval and Memory contract', () => {
  ...
  it('keeps the single active Roadmap priority on V2.1 Slice 5 while Context integration progresses', () => {
    ...
    expect(plan).toMatch(/197 test files and 2782 tests/u)
    ...
    expect(roadmap).toContain('| Next gate | Prove exact-version Memory deletion/purge and zero-repeat packaged restart |')
